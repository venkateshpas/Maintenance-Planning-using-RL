...
risk1 = np.arange(0.1,1,0.01) #Risk factor for inspecting a component
risk2 = np.arange(0.2,1,0.01) #Risk factor for repairing a component: Since it is a major cost start repairing if more than 0.5 only.
...
action_plot(int(1),'risk',results_risk)
...
action_plot(int(1),'age',results_age)
